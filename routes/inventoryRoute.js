...
router.get("/", utilities.authorizeAdmin, utilities.handleErrors(invController.builManagement));
//Route to Add Classificatoin
router.get("/add-classification", utilities.authorizeAdmin, utilities.handleErrors(invController.buildAddClassification));
...
router.get("/add-inventory", utilities.authorizeAdmin, utilities.handleErrors(invController.buildAddInventory));
...
router.get("/edit/:inv_id", utilities.authorizeAdmin, utilities.handleErrors(invController.buildEditInventory))
...
router.get("/delete/:inv_id", utilities.authorizeAdmin, utilities.handleErrors(invController.buildDelete))
