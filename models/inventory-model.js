...
// Add new classification to classification table
async function addClassificationToDB(classification_name) {
  try {
...
async function addVehicle(classification_id, inv_make, inv_model, inv_year, inv_description, inv_image, inv_thumbnail, inv_price, inv_miles, inv_color){
 ...
 module.exports = {getClassifications, getInventoryByClassificationId, getProductById, addClassificationToDB, addVehicle};